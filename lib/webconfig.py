FOLDERS = {'UPLOAD': 'from-client', 'DOWNLOAD': 'to-client', 'ARCHIVE': 'data-archive', 'GRAPHS': 'static/graphs'}
DATA_DIRS = {'RAW': '0_raw', 'RAW_ZDB':'6_raw_zdb', 'FINAL': '5_final_lstm', 'FINAL_ZDB': '9_final_zdb_lstm', 'GRAPHS':'10_images'}
